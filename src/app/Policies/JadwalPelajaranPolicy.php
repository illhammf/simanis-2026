...
class JadwalPelajaranPolicy
{
    ...
    {
        return $user->can('view_any_jadwal::pelajaran');
    }
    ...
    {
        return $user->can('view_jadwal::pelajaran');
    }
    ...
    {
        return $user->can('create_jadwal::pelajaran');
    }
    ...
    {
        return $user->can('update_jadwal::pelajaran');
    }
    ...
    {
        return $user->can('delete_jadwal::pelajaran');
    }
    ...
    {
        return $user->can('delete_any_jadwal::pelajaran');
    }
