...
class TujuanPembelajaranPolicy
{
    ...
    {
        return $user->can('view_any_tujuan::pembelajaran');
    }
    ...
    {
        return $user->can('view_tujuan::pembelajaran');
    }
    ...
    {
        return $user->can('create_tujuan::pembelajaran');
    }
    ...
    {
        return $user->can('update_tujuan::pembelajaran');
    }
    ...
    {
        return $user->can('delete_tujuan::pembelajaran');
    }
    ...
    {
        return $user->can('delete_any_tujuan::pembelajaran');
    }
     ...
     */
    public function replicate(User $user, TujuanPembelajaran $tujuanPembelajaran): bool
    {
